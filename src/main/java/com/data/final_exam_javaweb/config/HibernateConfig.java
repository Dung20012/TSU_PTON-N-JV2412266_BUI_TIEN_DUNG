package com.data.final_exam_javaweb.config;
...
public class HibernateConfig {
    ...
    public SessionFactory sessionFactory() {
        ...
        sessionBuilder.scanPackages("com.data.final_exam_javaweb.model.entity"); // package containing your entity classes
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/advertising_strategy?createDatabaseIfNotExist=true");// replace with your database URL
